...
public:
    ...
    /**
     * Returns the index of parent of given data point index in this priority queue.
     *
     * This operation must run in time O(1).
     *
     * @return The index of parent of given data point index in this priority queue.
     */
    int parent(int i) const;

    /**
     * Returns the index of left child of given data point index in this priority queue.
     *
     * This operation must run in time O(1).
     *
     * @return The index of left child of given data point index in this priority queue.
     */
    int left(int i) const;

    /**
     * Returns the index of right child of given data point index in this priority queue.
     *
     * This operation must run in time O(1).
     *
     * @return The index of right of given data point index in this priority queue.
     */
...
private:
    ...
    void grow();
    void swap(DataPoint*x, DataPoint*y);
